...
import { bindLenisToGsap } from './website/lib/gsapScroll';
...
import WebsiteHowItWorks from './website/pages/HowItWorks';
import WebsiteMaterials from './website/pages/Materials';
import WebsiteDealers from './website/pages/Dealers';
import WebsiteContact from './website/pages/Contact';
import WebsiteFaq from './website/pages/Faq';
import WebsitePrivacy from './website/pages/Privacy';
import CatchAll from './website/CatchAll';
import EcommerceReload from './website/EcommerceReload';
import { WebsiteContentProvider } from './website/cms';
...
const useSmoothScroll = () => {
  React.useEffect(() => {
    ...
    window.lenis = lenis;
    const unbindGsap = bindLenisToGsap(lenis);
  ...
  return (
    <WebsiteContentProvider>
      <Router>
        ...
        <MetaPixelTracker />
        <Routes>
          <Route path="/admin/*" element={<ShopProvider><AdminRoutes /></ShopProvider>} />
          <Route path="/vendor/*" element={<VendorRoutes />} />
          <Route path="/app" element={<EcommerceReload />} />
          <Route path="/app/*" element={<EcommerceReload />} />
          <Route element={<WebsiteLayout />}>
            <Route path="/" element={<WebsiteHome />} />
            <Route path="/about" element={<WebsiteAbout />} />
            <Route path="/how-it-works" element={<WebsiteHowItWorks />} />
            <Route path="/products" element={<WebsiteMaterials />} />
            <Route path="/dealers" element={<WebsiteDealers />} />
...
function App() {
  useSmoothScroll();
  if (isEcommercePath()) return <EcommerceApp />;
  return <SiteApp />;
}
